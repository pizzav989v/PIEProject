...
<div class="login-page" align = "center">
  ...
  <h3>Alege una dintre tabelele urmatoare: </h3>
    ...
    <a href="AngajatController?action=listAngajat" class="button">Angajat</a><br /><br />
    ...
    <a href="DepartamentController?action=listDepartament" class="button">Departament</a><br /><br />
    <a href="ProdusController?action=listProdus" class="button">Produs</a><br /><br />
    <a href="UtilizatorController?action=listUtilizator" class="button">Utilizator</a><br /><br />
  </div>
</body>
</html>